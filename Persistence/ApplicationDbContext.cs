...
namespace Persistence
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public virtual DbSet<Subcategory_Attribute> Subcategory_Attribute { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Category_Attribute>().HasKey(ca => new {ca.Id_Category, ca.Id_Attribute });
            modelBuilder.Entity<Subcategory_Attribute>().HasKey(sa => new {sa.Id_Subcategory, sa.Id_Attribute});
        }
    }
}
